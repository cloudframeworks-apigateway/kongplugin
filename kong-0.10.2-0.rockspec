...
build = {
  ...
  modules = {
    ...
    ["kong.plugins.test.access"] = "kong/custom_plugins/test/access.lua",
    ["kong.plugins.test.handler"] = "kong/custom_plugins/test/handler.lua",
    ["kong.plugins.test.schema"] = "kong/custom_plugins/test/schema.lua",

    ["kong.plugins.log2zmq.zhelpers"] = "kong/custom_plugins/log2zmq/zhelpers.lua",
    ["kong.plugins.log2zmq.handler"] = "kong/custom_plugins/log2zmq/handler.lua",
    ["kong.plugins.log2zmq.schema"] = "kong/custom_plugins/log2zmq/schema.lua",
    ["kong.plugins.log2zmq.serializers"] = "kong/custom_plugins/log2zmq/serializers.lua",

    ["kong.plugins.accesslimiting.migrations.cassandra"] = "kong/custom_plugins/accesslimiting/migrations/cassandra.lua",
    ["kong.plugins.accesslimiting.migrations.postgres"] = "kong/custom_plugins/accesslimiting/migrations/postgres.lua",
    ["kong.plugins.accesslimiting.handler"] = "kong/custom_plugins/accesslimiting/handler.lua",
    ["kong.plugins.accesslimiting.access"] = "kong/custom_plugins/accesslimiting/access.lua",
    ["kong.plugins.accesslimiting.api"] = "kong/custom_plugins/accesslimiting/api.lua",
    ["kong.plugins.accesslimiting.schema"] = "kong/custom_plugins/accesslimiting/schema.lua",
    ["kong.plugins.accesslimiting.dao.cassandra"] = "kong/custom_plugins/accesslimiting/dao/cassandra.lua",
    ["kong.plugins.accesslimiting.dao.postgres"] = "kong/custom_plugins/accesslimiting/dao/postgres.lua",
